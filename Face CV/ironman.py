            ...
            if resultf.multi_face_landmarks:
                for face_landmarks in resultf.multi_face_landmarks:
                    mp_draw.draw_landmarks(
                        ...
                        connections=mp_face.FACEMESH_CONTOURS,  # Replace with FACEMESH_TESSELATION if needed
                        landmark_drawing_spec=mp_draw.DrawingSpec(color=(0, 215, 255), thickness=1, circle_radius=1),
